...
OMNIDIST_VERSION="${GITHUB_REF_NAME#v}" npx omnidist --profile default build
npx omnidist --profile default npm stage
npx omnidist --profile default npm verify
npx omnidist --profile default npm publish
```
